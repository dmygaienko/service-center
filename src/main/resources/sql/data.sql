insert into user (id, email, first_name, surname, address, password, contact_number)
values          ( 11, 'email11@test.com', 'first_name1', 'surname11', 'address11', '$2a$16$lTyv11iO3BhUq0sjXeLSsegRBb2RFx4B.ElmoEKNfZMwF4vD1nXj2', 'contact_number' ),
